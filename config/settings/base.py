...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://localhost/landescape")
}
...
LOCAL_APPS = [
    ...
    "landescape.bookings.apps.BookingsConfig",
]
...
MIGRATION_MODULES = {"sites": "landescape.contrib.sites.migrations"}
...
ADMINS = [("""Tim Sokollek""", "tim@sokollek.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "landescape.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
